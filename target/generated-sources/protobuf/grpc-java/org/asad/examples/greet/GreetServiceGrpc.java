...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.asad.examples.greet.GreetRequest,
      org.asad.examples.greet.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = org.asad.examples.greet.GreetRequest.class,
      responseType = org.asad.examples.greet.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.asad.examples.greet.GreetRequest,
      org.asad.examples.greet.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<org.asad.examples.greet.GreetRequest, org.asad.examples.greet.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod = 
              io.grpc.MethodDescriptor.<org.asad.examples.greet.GreetRequest, org.asad.examples.greet.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "greet.GreetService", "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.asad.examples.greet.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.asad.examples.greet.GreetResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greet(org.asad.examples.greet.GreetRequest request,
        io.grpc.stub.StreamObserver<org.asad.examples.greet.GreetResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.asad.examples.greet.GreetRequest,
                org.asad.examples.greet.GreetResponse>(
                  this, METHODID_GREET)))
          .build();
    }
  }
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetServiceBlockingStub> {
     ...
     * </pre>
     */
    public org.asad.examples.greet.GreetResponse greet(org.asad.examples.greet.GreetRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractStub<GreetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.asad.examples.greet.GreetResponse> greet(
        org.asad.examples.greet.GreetRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((org.asad.examples.greet.GreetRequest) request,
              (io.grpc.stub.StreamObserver<org.asad.examples.greet.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.asad.examples.greet.GreetProto.getDescriptor();
    }
