...
public class jmDNSServiceTracker implements ServiceListener {
    ...
    ServiceObserver observer; //make Array of service if you want to use many 
    ...
    public static jmDNSServiceTracker getInstance() { //one if it as been created before just use it creat it or else use same one
        if (instance == null) {
